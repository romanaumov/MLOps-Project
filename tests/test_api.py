...
class TestAPI:
    ...
    def test_predict_single_success(self, mock_predictor, client, sample_prediction_input):
    ...
    @patch('src.api.main.predictor')
    def test_predict_single_error(self, mock_predictor, client, sample_prediction_input):
    ...
    def test_predict_batch(self, mock_predictor, client, sample_prediction_input):
        ...
        batch_input = {
            "inputs": [sample_prediction_input, sample_prediction_input]
        }
    ...
    @patch('src.api.main.predictor')
    def test_predict_with_confidence(self, mock_predictor, client, sample_prediction_input):
