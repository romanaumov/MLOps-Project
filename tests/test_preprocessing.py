...
class TestDataPreprocessor:
    ...
    def test_create_features(self, preprocessor, sample_data):
        ...
        expected_features = [
            ...
            'temp_hum_interaction', 'feels_like_temp', 'is_weekend'
        ]
    ...
    def test_preprocess_pipeline(self, mock_load_data, preprocessor, sample_data):
        ...
        assert set(y_train.values).union(set(y_test.values)) == set(sample_data['cnt'].values)
    
    def test_split_data(self, preprocessor, sample_data):
        X_train, X_test, y_train, y_test = preprocessor.split_data(sample_data, test_size=0.25)
